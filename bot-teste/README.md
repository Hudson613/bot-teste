...
O bot-teste é um bot do modificado do [MhankBar](https://github.com/MhankBarBar/termux-wabot) e traduzido para o português pt-br, e usado no termux e é bem facil a instalação, segue os comandos de como instalar o bot-teste
...
```
git clone https://github.com/Hudson613/bot-teste.git
cd bot-teste
bash install.sh
npm install
